...
$(document).ready(function() {
    ...
    var currentDate = yy + "/" + mm + "/" + dd + 1;

    $('#clockFlat').countdown('2020/10/10').on('update.countdown', function(event) {
      var $this = $(this).html(event.strftime(''
        + '<div class="clockCard px-1"> <span>%-w</span> <br> <p class="bg-amber clockFormat lead px-1 black"> Week%!w </p> </div>'
