...
$(document).ready(function() {
  ...
  let board_item_id, board_item_el;
  let board_item_users, board_item_dueDate, board_item_comment, board_item_attachment, board_item_image, board_item_badge;
  ...
  addBoardDefault.addEventListener("click", function() {
    ...
    // 1. Make the board title div editable, i.e add the contenteditable property
    // 2. Properly initialize the dropdown above on line 321, as this is does not work as expected
