...
$(document).ready(function () {
  ...
  // Tap
  const tapSlider = document.getElementById('tap');
  ...
  // Fixed dragging
  const dragFixedSlider = document.getElementById('drag-fixed');
  ...
  // Hover
  const hoverSlider = document.getElementById('hover'),
  ...
  // Combined options
  const dragTapSlider = document.getElementById('combined');
